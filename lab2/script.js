...
mapboxgl.accessToken =
  "pk.eyJ1IjoicWluZ3lhbmdjaGUiLCJhIjoiY21rY2gwYms5MDB4dzNxczZ1azFvMnRxdCJ9.nKH72f0YsGG-AAYZvIjQiA";

// Define a map object by initialising a Map from Mapbox
const map = new mapboxgl.Map({
  container: "map",
  // Replace YOUR_STYLE_URL with your style URL.
  style: "mapbox://styles/qingyangche/cmkmnlcc0001101sdc1gl531f",
  center: [-4.25, 55.86],
  zoom: 10
});
